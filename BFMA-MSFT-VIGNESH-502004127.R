library(forecast)
mydata = read.csv("C:\\Users\\DELL\\Desktop\\MSFT.csv",header = TRUE)
View(mydata)
spy = ts(mydata[,2],frequency = 21)
...
plot(spy,main=" MSFT - ADJUSTED CLOSE: 2019-2021",ylab="ADJUSTED CLOSE",xlab="MONTH")
...
plot(brown1,main=" MSFT - Brown Simple Exponential Smoothing ETS(A,N,N)",ylab="Price",xlab="Month")
lines(spy,lty=3)
...
plot(holt1,main=" MSFT - Holt Linear Trend ETS(A,A,N)",ylab="Adjusted Close",xlab="Month")
lines(spy,lty=3)
...
plot(hwa1,main=" MSFT - Holt-Winters Additive ETS(A,A,A) Method 1",ylab="Adjusted Close",xlab="Month")
lines(spy,lty=3)
...
plot(hwm1,main=" MSFT - Holt-Winters Multiplicative ETS(A,A,M) Method 1",ylab="Adjusted Close",xlab="Month")
lines(spy,lty=3)
...
plot(gardner1,main=" MSFT - Gardner Additive Damped Trend ETS(A,Ad,N) Method 1",ylab="Adjusted Close",xlab="Month")
lines(spy,lty=3)
...
plot(taylor1,main=" MSFT - Taylor Multiplicative Damped Trend ETS(A,Md,N) Method 1",ylab="Adjusted Close",xlab="Month")
lines(spy,lty=3)
...
plot(hwm3,main="MSFT- Holt-Winters Damped ETS(A,A,M)",ylab="Adjusted Close",xlab="Month")
lines(spy,lty=3)
